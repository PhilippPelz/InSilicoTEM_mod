...
params.proc.N               = round(500 * 1.17647058824,0); % Image size (field of view)
...
params.acquis.df             = [1.6]*1e-6; % Defocus [m]. Note: undefocus df>0; overfocus df <0. 
...
% dipshow((InputVol(:,:,20)));
dip_randomseed(443221311)
fn = '/home/philipp/drop/Philipp/mypapers/lowdose/data/figure2_snr_frc/4v6x/4v6x_300_defocused TEM_05_1.h5';
params2.fn = fn;
h5create(fn,'/dose',1);
