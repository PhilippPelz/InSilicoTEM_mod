...
params.proc.N               = 768; % Image size (field of view)
params.proc.partNum         = 9;   % Number of particles. 
...
params.spec.imagpot         = 2;            % Amplitude contrast flag. Options: (=0, none) (=1 constant Q) (=2 ice "plasmons") (=3 'plasmons" of ice and protein)         
...
params.acquis.pixsize        = 1e-10;   % Pixel size in the specimen plane [m]3748
...
params.acquis.Voltage        = 20e3;       % Acceleration voltage
params.acquis.tilt           = [0]/180*pi;  % Tilt geometry -20:5:20 
params.acquis.dose_on_sample = [10]/length(params.acquis.tilt); % Integrated flux (for the full tilt series) [e-/A2]



% ----------------------- Detector-Camera (cam field)
params.cam.type              = 'ideal'; % Options: 'custom', 'Eagle4k', 'US4000', 'US1000GIF', 'FalconI', 'perfect' (64% at Nq -counting mode), 'ideal' (100% at Nq)
...
params.cam.DQEflag          = 0; % Flag for dqe (=0 means NTF = MTF)
