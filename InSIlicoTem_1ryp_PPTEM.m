...
params.proc.N               = 300; % Image size (field of view)
...
params.acquis.df             = [60]*1e-9; % Defocus [m]. Note: undefocus df>0; overfocus df <0. 
...
% dipshow((InputVol(:,:,20)));
dip_randomseed(3112413432)
fn = '/home/philipp/dropbox/Philipp/mypapers/lowdose/data/figure2_snr_frc/1ryp_300_phase-plate TEM_20_111112111.h5';
params2.fn = fn;
h5create(fn,'/dose',1);
...
figure;
imagesc(double(imStructOut.noiseless_series));
colorbar;      
figure;
imagesc(double(imStructOut.series));
colorbar;    
